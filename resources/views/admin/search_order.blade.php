...
<ul class="breadcrumb">
    ...
    <div>
     <a href="{{URL::to('/all-custom-order')}}" class="btn btn-warning">All Order</a>
    </div>		   
	</li>
</ul>
...
<div class="row-fluid sortable">
	<div class="box span12">
		<div class="box-header" data-original-title>
			<h2><i class="halflings-icon user"></i><span class="break"></span>Custom Orders</h2>
			<div class="box-icon">
		...
		<div class="box-content">
			<table class="table table-striped table-bordered bootstrap-datatable datatable">
				...
				@foreach($result->unique('order_id') as $o)
				<tbody>
					<tr>
						...
						<td class="text-center">
                            <div class="btn btn-group">
                                <a class="btn btn-primary btn-sm" href="{{URL::to('/custom-order-detail/'.$o->order_id)}}">
									<i class="fa fa-eye white eye"></i>
								</a>
